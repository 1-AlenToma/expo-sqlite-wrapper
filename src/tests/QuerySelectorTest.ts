...
const database = {
  delete: async () => {},
  save: async () => {},
  querySelector: (tbName: TableNames) =>
    new QuerySelector<any, TableNames>(
      tbName,
      database
    ),
  tables: tables
...
mocha.describe("testWhere", function () {
  ...
  const q2 = Functions.translateSimpleSql(
    database,
    "DetaliItems",
    { novel: "test", title: "hey" }
  );
  const q3 = Functions.translateSimpleSql(
    database,
    "DetaliItems"
  );
  q.sql.should.eql(
    "SELECT * FROM DetaliItems WHERE novel IN (?, ?) AND title=? "
  );
  q.args[0].should.eql(
    "#dbEncrypted&iwx3MskszSgNcP8QDQA7Ag=="
  );
  q.args[2].should.eql("hey");
  q2.sql.should.eql(
    "SELECT * FROM DetaliItems WHERE novel=? AND title=? "
  );
  q2.args[0].should.eql(
    "#dbEncrypted&iwx3MskszSgNcP8QDQA7Ag=="
  );
...
mocha.describe(
  "testgetAvailableKeys",
  function () {
    const items = Functions.getAvailableKeys(
      ["name", "id", "password"],
      {
        password: "test"
      }
...
mocha.describe("readEncryption", function () {
  ...
  var q = new QuerySelector<
    DetaliItems,
    TableNames
  >("DetaliItems", database) as IQuerySelector<
    DetaliItems,
    TableNames
  >;
  ...
  sql
    ...
    .sql.trim()
    .should.eql(
      "SELECT * FROM DetaliItems WHERE novel = ? AND title = ? ORDER BY title ASC Limit 100"
    );
  sql
    .getSql("SELECT")
    .args[0].should.eql(
...
mocha.describe("startWith", function () {
  ...
  sql.sql
    .trim()
    .should.eql(
      "SELECT * FROM DetaliItems WHERE novel = ? AND title = ? AND title NOT like novel + '%' ( title like ? ) ORDER BY title ASC Limit 100"
    );
  sql.args[0].should.eql(
    "#dbEncrypted&iwx3MskszSgNcP8QDQA7Ag=="
  );
...
mocha.describe("JsonToSql", function () {
  ...
  sql.sql
    .trim()
    .should.eql(
      "select * from DetaliItems join Chapters on DetaliItems.id = Chapters.detaliItem_Id where DetaliItems.id > 1 and DetaliItems.title = ?;"
    );
});

mocha.describe(
  "bulkSaveWithEncryptionsInsert",
  function () {
    console.log("bulkSaveWithEncryptionsInsert");
    const b = new BulkSave<
      DetaliItems,
      TableNames
    >(
      database,
    ...
    b.quries[0].args[1].should.eql(
      "#dbEncrypted&0eUCHRbFc8mdr94/KJYKOA=="
    );
...
mocha.describe("DeleteWithSearch", function () {
  ...
  sql.sql
    .trim()
    .should.eql(
      "DELETE FROM DetaliItems WHERE ( id = ? )"
    );
...
mocha.describe(
  ...
  function () {
    ...
    sql.sql
      .trim()
      .should.eql(
        "DELETE FROM DetaliItems WHERE ( id NOT IN( ?, ? ) )"
      );
...
mocha.describe(
  ...
  function () {
    ...
    sql.sql
      .trim()
      .should.eql(
        "DELETE FROM DetaliItems WHERE ( image NOT IN( ? ) )"
      );
    sql.args[0].should.eql(
      "#dbEncrypted&0eUCHRbFc8mdr94/KJYKOA=="
    );
...
mocha.describe("LimitTest", function () {
  ...
  sql.sql
    .trim()
    .should.eql(
      "SELECT * FROM DetaliItems Limit 100"
    );
  sql.args.length.should.eql(0);
});
...
mocha.describe("OrderDesc", function () {
  ...
  sql.sql
    .trim()
    .should.eql(
      "SELECT * FROM DetaliItems ORDER BY id DESC"
    );
  sql.args.length.should.eql(0);
});
...
mocha.describe("OrderAsc", function () {
  ...
  sql.sql
    .trim()
    .should.eql(
      "SELECT * FROM DetaliItems ORDER BY id ASC"
    );
  sql.args.length.should.eql(0);
});
...
mocha.describe("WhereColumn", function () {
  ...
  sql.sql
    .trim()
    .should.eql(
      "SELECT * FROM DetaliItems WHERE title like ? ORDER BY id DESC"
    );
  sql.args.length.should.eql(1);
...
mocha.describe("lessString", function () {
  ...
  sql.sql
    .trim()
    .should.eql(
      "SELECT * FROM DetaliItems WHERE id < ?"
    );
...
mocha.describe("innerjoin", function () {
  ...
  >(
    ...
    TableNames
  >;
  q.InnerJoin<Chapters, "b">("Chapters", "b")
    .Column(x => x.a.id)
  ...
  sql.sql
    .trim()
    .should.eql(
      "SELECT * FROM DetaliItems as a INNER JOIN Chapters as b ON  a.id = b.detaliItem_Id WHERE a.id < ?"
    );
  sql.args[0].should.eql(15);
  sql.args.length.should.eql(1);
...
mocha.describe("leftjoin", function () {
  ...
  >;
  const sql = q
    .LeftJoin<Chapters, "b">("Chapters", "b")
    .Column(x => x.a.id)
    .EqualTo(x => x.b.detaliItem_Id)
    .Where.Column(x => x.a.id)
    .LessThan(15)
  ...
  sql.sql
    .trim()
    .should.eql(
      "SELECT * FROM DetaliItems as a LEFT JOIN Chapters as b ON  a.id = b.detaliItem_Id WHERE a.id < ?"
    );
  sql.args[0].should.eql(15);
  sql.args.length.should.eql(1);
...
mocha.describe("HAVING", function () {
  ...
  sql.sql
    .trim()
    .should.eql(
      "SELECT a.title as setoNaming , count(b.chapterUrl) as sName FROM DetaliItems as a LEFT JOIN Chapters as b ON  a.id = b.detaliItem_Id WHERE a.id < ? GROUP BY a.id HAVING sName > ? ORDER BY a.title ASC, a.id DESC, b.chapterUrl DESC"
    );
  sql.args[0].should.eql(15);
...
mocha.describe("SimpleSql", function () {
  ...
  sql
    .trim()
    .should.eql(
      "SELECT a.title as setoNaming , count(b.chapterUrl) as sName FROM DetaliItems as a LEFT JOIN Chapters as b ON  a.id = b.detaliItem_Id WHERE a.id < 15 AND a.title NOT like '?%' GROUP BY a.id HAVING sName > 4 ORDER BY a.title ASC, a.id DESC, b.chapterUrl DESC"
    );
...
mocha.describe("InnerSelect", function () {
  ...
  sql
    .trim()
    .should.eql(
      "SELECT a.title as setoNaming , count(b.chapterUrl) as sName FROM DetaliItems as a LEFT JOIN Chapters as b ON  a.id = b.detaliItem_Id WHERE a.id < 15 AND a.title NOT like '?%' AND a.novel NOT IN( SELECT novel FROM DetaliItems WHERE id > 1 ) GROUP BY a.id HAVING sName > 4 ORDER BY a.title ASC, a.id DESC, b.chapterUrl DESC"
    );
  console.log(
    "InnerSelect",
    q.getInnerSelectSql()
...
mocha.describe("Join", function () {
  ...
  sql
    .trim()
    .should.eql(
      "SELECT a.title as setoNaming , count(b.chapterUrl) as sName FROM DetaliItems as a JOIN Chapters as b ON  a.id = b.detaliItem_Id WHERE a.id < 15 AND a.title NOT like '?%' AND a.novel NOT IN( SELECT novel FROM DetaliItems WHERE id > 1 ) GROUP BY a.id HAVING sName > 4 ORDER BY a.title ASC, a.id DESC, b.chapterUrl DESC"
    );
...
mocha.describe("CrossJoin", function () {
  ...
  >;
  const sql = q
    .CrossJoin<Chapters, "b">("Chapters", "b")
    .Column(x => x.a.id)
    .EqualTo(x => x.b.detaliItem_Id)
    .Where.Column(x => x.a.id)
    .LessThan(15)
  ...
  sql
    .trim()
    .should.eql(
      "SELECT a.title as setoNaming , count(b.chapterUrl) as sName FROM DetaliItems as a CROSS JOIN Chapters as b ON  a.id = b.detaliItem_Id WHERE a.id < 15 AND a.title NOT like '?%' AND a.novel NOT IN( SELECT novel FROM DetaliItems WHERE id > 1 ) GROUP BY a.id HAVING sName > 4 ORDER BY a.title ASC, a.id DESC, b.chapterUrl DESC"
    );
...
mocha.describe("EmptyJoin", function () {
  ...
  sql
    .trim()
    .should.eql(
      "SELECT a.title as setoNaming , count(b.chapterUrl) as sName FROM DetaliItems as a JOIN Chapters as b WHERE a.id < 15 AND a.title NOT like '?%' AND a.novel NOT IN( SELECT novel FROM DetaliItems WHERE id > 1 ) GROUP BY a.id HAVING sName > 4 ORDER BY a.title ASC, a.id DESC, b.chapterUrl DESC"
    );
...
mocha.describe("ValueAndBetWeen", function () {
  ...
  sql
    .trim()
    .should.eql(
      "SELECT a.title as setoNaming , count(b.chapterUrl) as sName FROM DetaliItems as a LEFT JOIN Chapters as b ON  a.id = b.detaliItem_Id WHERE a.id < 15 AND a.title NOT like '?%' AND a.novel NOT IN( SELECT novel FROM DetaliItems WHERE id > 1 ) GROUP BY a.id HAVING sName > 4 AND a.id BETWEEN 2 AND 5 ORDER BY a.title ASC, a.id DESC, b.chapterUrl DESC"
    );
  console.log(
    "ValueAndBetWeen",
    q.getInnerSelectSql()
...
mocha.describe("Aggrigators", function () {
  ...
  sql
    .trim()
    .should.eql(
      "SELECT a.title as setoNaming , count(*) as sName , sum(a.id) as s , a.title || '-' || a.id as NameAndId FROM DetaliItems as a LEFT JOIN Chapters as b ON  a.id = b.detaliItem_Id WHERE a.id < 15 AND ( a.title || '-' || a.id ) like '%1' AND a.title NOT like '?%' AND a.novel NOT IN( SELECT novel FROM DetaliItems WHERE id > 1 ) GROUP BY a.id HAVING sName > 4 AND a.id BETWEEN 2 AND 5 ORDER BY a.title ASC, a.id DESC, b.chapterUrl DESC"
    );
  console.log(
    "Aggrigators",
    q.getInnerSelectSql()
...
mocha.describe("Union", function () {
  ...
  const sql = q
    ...
    .Union(x =>
      x
        .querySelector<Chapters>("Chapters")
        .Where.Column(x => x.id)
        .GreaterThan(1)
  ...
  sql
    .trim()
    .should.eql(
      "SELECT a.title as setoNaming FROM DetaliItems as a LEFT JOIN Chapters as b ON  a.id = b.detaliItem_Id WHERE a.id < 15 AND ( a.title || '-' || a.id ) like '%1' AND a.title NOT like '?%' AND a.novel NOT IN( SELECT novel FROM DetaliItems WHERE id > 1 ) UNION SELECT chapterUrl FROM Chapters WHERE id > 1 AND chapterUrl NOT like '#dbEncrypted&JY+5fBsP75gn/K/VA1KFkQ==%'"
    );
